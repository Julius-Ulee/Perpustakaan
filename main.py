...
def main2 ():
     library = Library([Color.PURPLE + "Laskar Pelangi", "ANjay", "eaea", "hoo", "18+", "bioskop", "Bumi", "Programming", "Akuntansi Dasar", "Buku Sastra dan Bahasa" + Color.END])
     student = Student()
     done = False
     while not done :
